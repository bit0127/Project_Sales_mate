...
public partial class pmdashboard : System.Web.UI.Page
{
    ...
    public static string CheckUserName(string uid)
    {
    ...
    public static string GetItemGroup(string ownCompany)
    {
        ...
        try
        {
            ...
            string query = @"SELECT ITEM_GROUP_ID,ITEM_GROUP_NAME FROM T_ITEM_GROUP
                            WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND COMPANY_ID='" + HttpContext.Current.Session["company"].ToString().Trim() + "'";
    ...
    public static string GetSRInfo(string company)
    {
        ...
        try
        {
            ...
            string query = @"SELECT T3.ITEM_GROUP,T3.SR_ID,T3.SR_NAME,T3.MOBILE_NO,T3.DIST_ID,T3.DIVISION_NAME,T4.ZONE_NAME FROM
                            ...
                            WHERE ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "' AND ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND COUNTRY_NAME LIKE '%" + HttpContext.Current.Session["country"].ToString() + "%' AND STATUS='Y') T1, ";
            ...
            if (division == "All" && zone == "All")
            {
                ...
                query = @"SELECT T5.* FROM  
                         (SELECT T3.*,T4.ZONE_NAME FROM
                          (SELECT T1.SR_ID,T1.SR_NAME,T1.MOBILE_NO,T1.ITEM_GROUP,T1.DIST_ZONE,T2.DIVISION_NAME FROM                                          
                         (SELECT SR_ID,SR_NAME,MOBILE_NO,ITEM_GROUP,DIVISION_NAME,DIST_ZONE FROM T_SR_INFO  
                         WHERE STATUS='Y' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "' AND ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND COUNTRY_NAME='" + HttpContext.Current.Session["country"].ToString() + "' AND SR_ID IN(SELECT DISTINCT SR_ID FROM T_ORDER_DETAIL WHERE ENTRY_DATE = TO_DATE('" + txtDate + "','dd/mm/yyyy'))) T1, ";
                query = query + @" (SELECT DIVISION_ID,DIVISION_NAME FROM T_DIVISION WHERE COUNTRY_NAME='" + HttpContext.Current.Session["country"].ToString() + "') T2 ";
                query = query + @" WHERE T1.DIVISION_NAME=T2.DIVISION_ID) T3,
                         (SELECT ZONE_ID,ZONE_NAME FROM T_ZONE WHERE COUNTRY_NAME='" + HttpContext.Current.Session["country"].ToString() + "') T4 ";
                query = query + @" WHERE T3.DIST_ZONE=T4.ZONE_ID) T5";
            ...
            else if (division != "All" && zone == "All")
            {
                query = @"SELECT T5.* FROM  
                         (SELECT T3.*,T4.ZONE_NAME FROM
                          (SELECT T1.SR_ID,T1.SR_NAME,T1.MOBILE_NO,T1.ITEM_GROUP,T1.DIST_ZONE,T2.DIVISION_NAME FROM                                          
                         (SELECT SR_ID,SR_NAME,MOBILE_NO,ITEM_GROUP,DIVISION_NAME,DIST_ZONE FROM T_SR_INFO  
                         WHERE STATUS='Y' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "' AND ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND COUNTRY_NAME='" + HttpContext.Current.Session["country"].ToString() + "' AND DIVISION_NAME = '" + division + "' AND SR_ID IN(SELECT DISTINCT SR_ID FROM T_ORDER_DETAIL WHERE ENTRY_DATE = TO_DATE('" + txtDate + "','dd/mm/yyyy'))) T1, ";
            ...
            else if (division == "All" && zone != "All")
            {
                query = @"SELECT T5.* FROM  
                         (SELECT T3.*,T4.ZONE_NAME FROM
                          (SELECT T1.SR_ID,T1.SR_NAME,T1.MOBILE_NO,T1.ITEM_GROUP,T1.DIST_ZONE,T2.DIVISION_NAME FROM                                          
                         (SELECT SR_ID,SR_NAME,MOBILE_NO,ITEM_GROUP,DIVISION_NAME,DIST_ZONE FROM T_SR_INFO  
                         WHERE STATUS='Y' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "' AND ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND COUNTRY_NAME='" + HttpContext.Current.Session["country"].ToString() + "' AND DIST_ZONE='" + zone + "' AND SR_ID IN(SELECT DISTINCT SR_ID FROM T_ORDER_DETAIL WHERE ENTRY_DATE = TO_DATE('" + txtDate + "','dd/mm/yyyy'))) T1, ";
                query = query + @" (SELECT DIVISION_ID,DIVISION_NAME FROM T_DIVISION WHERE COUNTRY_NAME='" + HttpContext.Current.Session["country"].ToString() + "') T2 ";
                query = query + @" WHERE T1.DIVISION_NAME=T2.DIVISION_ID) T3,
        ...
        try
        {
            ...
            if (division != "All" && zone != "All")
            {
                ...
                query = query + @" (SELECT T5.*,T6.TSM FROM
                            ...
                            (SELECT T1.SR_ID,T1.SR_NAME,T1.MOBILE_NO,T1.ITEM_GROUP,T1.DIST_ZONE,T2.DIVISION_NAME FROM
                            (SELECT SR_ID,SR_NAME,MOBILE_NO,ITEM_GROUP,DIVISION_NAME,DIST_ZONE FROM T_SR_INFO
                            WHERE STATUS='Y' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "' AND ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND DIVISION_NAME='" + division + "' AND DIST_ZONE='" + zone + "') T1, ";
                query = query + @"(SELECT DIVISION_ID,DIVISION_NAME FROM T_DIVISION) T2
            ...
            else if (division == "All")
            {
                ...
                query = query + @" (SELECT T5.*,T6.TSM FROM
                            ...
                            (SELECT T1.SR_ID,T1.SR_NAME,T1.MOBILE_NO,T1.ITEM_GROUP,T1.DIST_ZONE,T2.DIVISION_NAME FROM
                            (SELECT SR_ID,SR_NAME,MOBILE_NO,ITEM_GROUP,DIVISION_NAME,DIST_ZONE FROM T_SR_INFO
                            WHERE STATUS='Y' AND ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "') T1, ";
                query = query + @"(SELECT DIVISION_ID,DIVISION_NAME FROM T_DIVISION) T2
                            WHERE T1.DIVISION_NAME=T2.DIVISION_ID) T3,
                            (SELECT ZONE_ID,ZONE_NAME FROM T_ZONE) T4
                            WHERE T3.DIST_ZONE=T4.ZONE_ID) T5,
            ...
            else if (division != "All" && zone == "All")
            {
                ...
                query = query + @" (SELECT T5.*,T6.TSM FROM
                            ...
                            (SELECT T1.SR_ID,T1.SR_NAME,T1.MOBILE_NO,T1.ITEM_GROUP,T1.DIST_ZONE,T2.DIVISION_NAME FROM
                            (SELECT SR_ID,SR_NAME,MOBILE_NO,ITEM_GROUP,DIVISION_NAME,DIST_ZONE FROM T_SR_INFO
                            WHERE STATUS='Y' AND ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "' AND DIVISION_NAME='" + division + "') T1, ";
                query = query + @"(SELECT DIVISION_ID,DIVISION_NAME FROM T_DIVISION) T2
                            WHERE T1.DIVISION_NAME=T2.DIVISION_ID) T3,
                            (SELECT ZONE_ID,ZONE_NAME FROM T_ZONE) T4
                            WHERE T3.DIST_ZONE=T4.ZONE_ID) T5,
    ...
    public static string GetDashboard(string companyName)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                qrGroup = @"SELECT T1.*,T2.COMPANY_NICK_NAME FROM
                                (SELECT COMPANY_ID,ITEM_GROUP_ID,ITEM_GROUP_NAME,MOTHER_COMPANY FROM T_ITEM_GROUP WHERE STATUS='Y' AND ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND COMPANY_ID='" + HttpContext.Current.Session["company"].ToString() + "') T1, ";
                qrGroup = qrGroup + @" (SELECT COMPANY_ID,COMPANY_NICK_NAME FROM T_COMPANY) T2
                                WHERE T1.COMPANY_ID=T2.COMPANY_ID";
                ...
                if (c > 0 && dsP.Tables[0].Rows[0][0].ToString() != "")
                {
                    ...
                    for (int i = 0; i < c; i++)
                    {
                        ...
                        qrOrd = qrOrd + @"(SELECT ITEM_ID,ITEM_SHORT_NAME FROM T_ITEM WHERE ITEM_GROUP='" + groupId + "') T2 "+
                        ...
                        if (ord > 0 && dsOrd.Tables[0].Rows[0][0].ToString() != "")
                        {
                            ...
                            for (int r = 0; r < ord; r++)
                            {
                                string itemName = dsOrd.Tables[0].Rows[r]["ITEM_SHORT_NAME"].ToString();
                                ordRow = ordRow + "<tr><td>" + slno.ToString() + ". " + itemName + "</td></tr>";
                                slno++;
                            }
                        }
                        ...
                        if (sr > 0 && dssr.Tables[0].Rows[0][0].ToString() != "0")
                        {
                            ...
                            if (Convert.ToInt32(activeSR) > 0)
                            {
                                ...
                                trRow2 = trRow2 + "<td><div style='width:100%;height:auto;margin-top: 5px;border:1px solid #8dc060;text-align:center;font-size:14px;padding-top:7px;padding-bottom: 7px; margin-left:1%;'>" +
                                                ...
                                                //"<span>Low to Top Ord Item</span></span></div>" +
                            ...
                            else
                            {
                                ...
                                trRow2 = trRow2 + "<td><div style='width:100%;height:auto;margin-top: 5px;border:1px solid #8dc060;text-align:center;font-size:14px;padding-top:7px;padding-bottom: 7px; margin-left:1%;'>" +
                                                ...
                                                "<div style='background-color:#ff9800;color:#fff;margin-left:2px;margin-right:2px;'>" +
                                                //"<span>Low to Top Ord Item</span></span></div>" +
                                                //"<div style='color:black;font-size:11px;margin-left:2px;margin-right:2px;overflow-y: scroll;'>" +
                                                //"<span>" + tblOrd + "</span><br/>" +
                        ...
                        else
                        {
                            trRow2 = trRow2 + "<td><div style='width:100%;height:auto;margin-top: 5px;border:1px solid #8dc060;text-align:center;font-size:14px;padding-top:7px;padding-bottom: 7px; margin-left:1%;'>" +
                                                ...
                                                "<div style='background-color:#ff9800;color:#fff;margin-left:2px;margin-right:2px;'>" +
                                                //"<span>Low to Top Ord Item</span></span></div>" +
                                                //"<div style='color:black;font-size:11px;margin-left:2px;margin-right:2px;height:173px;overflow-y: scroll;'>" +
                                                //"<span></span><br/>" +
                                            "</div></td>";
                        }
                    }
                    ...
                    string qrOrds = @"SELECT T2.ITEM_SHORT_NAME FROM
                                        (SELECT ITEM_ID,SUM((ITEM_QTY*OUT_PRICE) + (ITEM_CTN*OUT_PRICE)) TOTAL_AMT FROM T_ORDER_DETAIL
                                        WHERE ENTRY_DATE=TO_DATE('" + currentDate + "','DD/MM/YYYY') AND SR_ID IN(SELECT DISTINCT SR_ID FROM T_SR_INFO WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString().Trim() + "' AND STATUS='Y') GROUP BY ITEM_ID ORDER BY TOTAL_AMT ASC) T1,";
                    qrOrds = qrOrds + @"(SELECT ITEM_ID,ITEM_SHORT_NAME FROM T_ITEM WHERE ITEM_GROUP='" + HttpContext.Current.Session["item_group"].ToString() + "') T2 "+
                                        @"WHERE T1.ITEM_ID=T2.ITEM_ID";
                    ...
                    if (ords > 0 && dsOrds.Tables[0].Rows[0][0].ToString() != "")
                    {
                        ...
                        {
                            string itemName = dsOrds.Tables[0].Rows[r]["ITEM_SHORT_NAME"].ToString();
                            ordRows = ordRows + "<tr><td>" + slno.ToString() + ". " + itemName + "</td></tr>";
                            slno++;
                        }
                    }
            ...
            try
            {
                ...
                if (c > 0 && dsP.Tables[0].Rows[0][0].ToString() != "")
                {
                    for (int i = 0; i < c; i++)
                    {
                        ...
                        string qrSR = @"SELECT COUNT(*) TOTAL_SR FROM T_SR_INFO WHERE ITEM_GROUP_ID IN(SELECT ITEM_GROUP_ID FROM T_ITEM_GROUP WHERE COMPANY_ID='" + companyId + "' AND ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND STATUS='Y')";
                        OracleCommand cmdsr = new OracleCommand(qrSR, con);
                        OracleDataAdapter dasr = new OracleDataAdapter(cmdsr);
                        DataSet dssr = new DataSet();
                        dasr.Fill(dssr);
                        ...
                        if (sr > 0 && dssr.Tables[0].Rows[0][0].ToString() != "0")
                        {
                            ...
                            string qrActiveSR = @"SELECT DISTINCT SR_ID FROM T_ORDER_DETAIL
                                                WHERE SR_ID IN(SELECT SR_ID FROM T_SR_INFO WHERE ITEM_GROUP_ID ='" + HttpContext.Current.Session["item_group"].ToString() + "') AND ENTRY_DATE BETWEEN TO_DATE('" + fdate + "','dd/mm/yyyy') AND TO_DATE('" + tdate + "','dd/mm/yyyy')";
                            OracleCommand cmdASR = new OracleCommand(qrActiveSR, con);
                            OracleDataAdapter daASR = new OracleDataAdapter(cmdASR);
                            DataSet dsASR = new DataSet();
                            daASR.Fill(dsASR);
                            ...
                            if (asr > 0 && dsASR.Tables[0].Rows[0][0].ToString() != "")
                            {
                                ...
                                string qrTotalOlt = @"SELECT COUNT(*) TOTAL_OUTLET FROM T_OUTLET
                                                    WHERE STATUS='Y' AND SR_ID IN(SELECT SR_ID TOTAL_SR FROM T_SR_INFO WHERE ITEM_GROUP_ID IN(SELECT ITEM_GROUP_ID FROM T_ITEM_GROUP WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND COMPANY_ID='" + companyId + "' AND STATUS='Y'))";
                                OracleCommand cmdOlt = new OracleCommand(qrTotalOlt, con);
                                OracleDataAdapter daOlt = new OracleDataAdapter(cmdOlt);
                                DataSet dsOlt = new DataSet();
                                daOlt.Fill(dsOlt);
                                ...
                                string qrVstOlt = @"SELECT DISTINCT OUTLET_ID FROM T_ORDER_DETAIL
                                                    WHERE SR_ID IN(SELECT SR_ID FROM T_SR_INFO WHERE ITEM_GROUP_ID IN(SELECT ITEM_GROUP_ID FROM T_ITEM_GROUP WHERE COMPANY_ID='" + companyId + "' AND ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND STATUS='Y')) AND ENTRY_DATE BETWEEN TO_DATE('" + fdate + "','dd/mm/yyyy') AND TO_DATE('" + tdate + "','dd/mm/yyyy') ";
                                qrVstOlt = qrVstOlt + @" UNION
                                                    SELECT DISTINCT OUTLET_ID FROM T_NON_PRODUCTIVE_SALES
                                                    WHERE SR_ID IN(SELECT SR_ID FROM T_SR_INFO WHERE ITEM_GROUP_ID IN(SELECT ITEM_GROUP_ID FROM T_ITEM_GROUP WHERE COMPANY_ID='" + companyId + "' AND ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND STATUS='Y')) AND ENTRY_DATE BETWEEN TO_DATE('" + fdate + "','dd/mm/yyyy') AND TO_DATE('" + tdate + "','dd/mm/yyyy') ";
                                ...
                                string qrAmt = @"SELECT TO_CHAR(SUM((T1.ITEM_QTY+(T1.ITEM_CTN*T2.FACTOR))*T1.OUT_PRICE),'999999999.99') AMT FROM         
                                                (SELECT * FROM T_ORDER_DETAIL    
                                                WHERE ENTRY_DATE BETWEEN TO_DATE('" + fdate + "','dd/mm/yyyy') AND TO_DATE('" + tdate + "','dd/mm/yyyy') AND SR_ID IN(SELECT SR_ID FROM T_SR_INFO WHERE ITEM_GROUP_ID ='" + HttpContext.Current.Session["item_group"].ToString() + "') T1, (SELECT ITEM_ID,FACTOR FROM T_ITEM) T2 WHERE T1.ITEM_ID=T2.ITEM_ID";
    ...
    public static string GetTopRatedSR(string topsr)
    {
        ...
        try
        {
            ...
            string query = @"SELECT DISTINCT T4.*,T3.TOTAL_AMT FROM
                ...
                @"AND SR_ID IN(SELECT SR_ID FROM T_SR_INFO WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "')) T1, " +
                @"(SELECT ITEM_ID,FACTOR FROM T_ITEM) T2
                WHERE T1.ITEM_ID=T2.ITEM_ID GROUP BY T1.SR_ID) T3,
                (
                  SELECT t1.*,t2.tsm_name,t2.tsm_mobile from
                  (SELECT SR_ID,SR_NAME,MOBILE_NO,ITEM_GROUP FROM T_SR_INFO WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "') t1, " +
    ...
    public static string GetTopSoldProduct(string topsr)
    {
        ...
        try
        {
            ...
            string query = @"SELECT T1.ITEM_ID,T2.ITEM_NAME,T2.ITEM_GROUP_NAME, (SUM(((T1.ITEM_CTN*T2.FACTOR)+T1.ITEM_QTY)*T1.OUT_PRICE)/1000) TOTAL_AMT FROM
                (SELECT SR_ID,ITEM_ID,ITEM_QTY,ITEM_CTN,OUT_PRICE FROM T_ORDER_DETAIL WHERE ENTRY_DATE=TO_DATE('" + currentDate.Trim() + "','DD/MM/YYYY') AND SR_ID IN(SELECT SR_ID FROM T_SR_INFO WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "')) T1, " +
                @"(
                    SELECT TT1.*,TT2.ITEM_GROUP_NAME FROM
                    (SELECT ITEM_ID,ITEM_NAME,FACTOR,ITEM_GROUP FROM T_ITEM WHERE ITEM_GROUP='" + HttpContext.Current.Session["item_group"].ToString() + "' AND OWN_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "') TT1, " +
    ...
    public static string GetTopLowOrderedProduct(string group, string fdate, string tdate)
    {
        ...
        try
        {
            ...
            if (group == "All")
            {
                ...
                query = query + @" (SELECT ITEM_ID,ITEM_NAME,FACTOR,ITEM_GROUP  FROM T_ITEM WHERE ITEM_GROUP='" + HttpContext.Current.Session["item_group"].ToString() + "' AND) T2 "+ 
                        @"WHERE T1.ITEM_ID=T2.ITEM_ID
    ...
    public static string GetNoOrderedProduct(string group, string fdate, string tdate)
    {
        ...
        try
        {
            ...
            if (group == "All")
            {
                ...
                query = query + @"(SELECT ITEM_GROUP_ID,ITEM_GROUP_NAME  FROM T_ITEM_GROUP WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "') T2 "+
    ...
    public static string GetDamageSummaryReport(string fdate, string tdate)
    {
        ...
        try
        {
            ...
            string qrDamage = @"SELECT T1.*,T2.ITEM_GROUP_NAME FROM
                                ...
                                WHERE SR_ID IN(SELECT SR_ID FROM T_SR_INFO WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "') AND ENTRY_DATE BETWEEN TO_DATE('" + fdate.ToString() + "','DD/MM/YYYY') AND TO_DATE('" + tdate.ToString() + "','DD/MM/YYYY') GROUP BY ITEM_CODE,ITEM_NAME,REASON,OUTLET_ID) T1, " +
    ...
    public static string GetDamageDetailsReport(string fdate, string tdate)
    {
        ...
        try
        {
            ...
            string query = @"SELECT T9.*,T10.ITEM_GROUP_NAME FROM
                            ...
                            (SELECT ITEM_CODE,ITEM_NAME,SUM(CARTON) CTN,SUM(PCS) PIECE,REASON,OUTLET_ID FROM T_DAMAGE 
                            WHERE SR_ID IN(SELECT SR_ID FROM T_SR_INFO WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "') AND ENTRY_DATE BETWEEN TO_DATE('" + fdate.ToString() + "','DD/MM/YYYY') AND TO_DATE('" + tdate.ToString() + "','DD/MM/YYYY') " +
    ...
    public static string GetOrderedProduct(string fdate)
    {
        ...
        try
        {
            ...
            string query = @"SELECT ITEM_ID,SUM(ITEM_CTN) CARTON,SUM(ITEM_QTY) PIECE FROM T_ORDER_DETAIL 
                            WHERE ENTRY_DATE=TO_DATE('" + fdate.Trim() + "','DD/MM/YYYY') AND SR_ID IN(SELECT SR_ID FROM T_SR_INFO WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString().Trim() + "') GROUP BY ITEM_ID";
    ...
    public static string GetOrderedProductDetails(string fdate)
    {
        ...
        try
        {
            ...
            string query = @"SELECT T3.*,T4.OUTLET_NAME FROM
                            ...
                            WHERE ENTRY_DATE=TO_DATE('" + fdate.Trim() + "','DD/MM/YYYY') AND SR_ID IN(SELECT SR_ID FROM T_SR_INFO WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString().Trim() + "')) T1, ";
    ...
    public static string GetSRWiseOutletInfo(string company)
    {
        ...
        try
        {
            ...
            string qrSR = @"SELECT SR_ID,SR_NAME,MOBILE_NO,ITEM_GROUP FROM T_SR_INFO WHERE SR_ID!='10169' AND ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND STATUS='Y' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "' ORDER BY SR_ID";
    ...
    public static string GetUserLogInfo(string currentDate)
    {
        ...
        try
        {
            ...
            string qrSR = @"SELECT USER_ID,LOGIN_TIME FROM T_USER_LOG WHERE LOGIN_DATE=TO_DATE('" + currentDate.Trim() + "','DD/MM/YYYY') ORDER BY USER_ID";
            OracleCommand cmd = new OracleCommand(qrSR, conn);
            OracleDataAdapter da = new OracleDataAdapter(cmd);
            DataSet ds = new DataSet();
            da.Fill(ds);
    ...
    public static string GetSampleInfo(string currentDate)
    {
        ...
        try
        {
            ...
            string qrSR = @"SELECT T9.*,T10.ZONE_NAME FROM
                            ...
                            (SELECT SR_ID,OUTLET_ID,ROUTE_ID,ITEM_ID,ITEM_CTN,ITEM_PCS,ITEM_PRICE FROM T_SAMPLE WHERE ENTRY_DATE=TO_DATE('" + currentDate.Trim().ToString() + "','DD/MM/YYYY')) T1, (SELECT SR_ID,SR_NAME ||'-'||MOBILE_NO SR_INFO FROM T_SR_INFO WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "') T2 ";
            qrSR = qrSR + @"WHERE T1.SR_ID=T2.SR_ID) T3,
                            (SELECT ITEM_ID,FACTOR,ITEM_NAME FROM T_ITEM WHERE ITEM_GROUP='" + HttpContext.Current.Session["item_group"].ToString() + "') T4 "+
        ...
        try
        {
            ...
            string query = @"SELECT T9.*,(((T9.ITEM_CTN*T9.FACTOR)+T9.ITEM_QTY)*T9.OUT_PRICE) TOTAL_ORDER_AMT, (((T9.DELIVERY_CTN*T9.FACTOR)+T9.DELIVERY_PCS)*T9.OUT_PRICE) TOTAL_DELIVERY_AMT FROM
                            ...
                            (SELECT T3.*,T4.OUTLET_NAME FROM
                             ...
                             WHERE IS_PROCESS='S' AND SR_ID IN(SELECT SR_ID FROM T_SR_INFO WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND ITEM_COMPANY='" + HttpContext.Current.Session["company"].ToString() + "' AND STATUS='Y') AND ENTRY_DATE BETWEEN TO_DATE('" + fdate + "','DD/MM/YYYY') AND TO_DATE('" + tdate + "','DD/MM/YYYY') ";
            query = query + @" ORDER BY OUTLET_ID) T1,
                             (SELECT SR_ID,SR_NAME,ITEM_GROUP FROM T_SR_INFO WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "') T2 "+
                             @"WHERE T1.SR_ID=T2.SR_ID) T3,
                             (SELECT OUTLET_ID,OUTLET_NAME FROM T_OUTLET) T4
                             WHERE T3.OUTLET_ID=T4.OUTLET_ID) T5,
                             (SELECT ITEM_ID,ITEM_NAME,FACTOR FROM T_ITEM WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "') T6 "+
    ...
    public static string GetOrderVSDeliveryReport(string fdate, string tdate)
    {
        ...
        try
        {
            ...
            string qrGrp = @"SELECT ITEM_GROUP_ID,ITEM_GROUP_NAME FROM T_ITEM_GROUP WHERE COMPANY_ID='" + HttpContext.Current.Session["company"].ToString() + "'AND ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND STATUS='Y'";
    ...
    public static string GetCompanyGroup(string ownCompany)
    {
        ...
        try
        {
            ...
            string query = @"SELECT ITEM_GROUP_ID,ITEM_GROUP_NAME FROM T_ITEM_GROUP WHERE ITEM_GROUP_ID='" + HttpContext.Current.Session["item_group"].ToString() + "' AND COMPANY_ID='" + HttpContext.Current.Session["company"].ToString() + "'";
            OracleCommand cmd = new OracleCommand(query, conn);
            OracleDataAdapter da = new OracleDataAdapter(cmd);
            DataSet ds = new DataSet();
            da.Fill(ds);
