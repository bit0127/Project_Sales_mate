...
$(function () {
    ...
    $.ajax({
        type: "POST",
        url: "operation.aspx/GetHosTargetInfo",
        ...
        success: function (response) {
            ...
            for (var i = 1; i < hosTargetInfo.length; i = i + 4) {
                ...
                row = row + "<tr style='text-align:left'><td>" + hosId + "</td><td>" + amount + "</td><td>" + month + "</td><td>" + year + "</td><td><div style='float:right;'><button type='button' style='float: right; margin-top: 0px;' class='btn btn-xs btn-success edithostid' id='" + hosId + "'><span class ='glyphicon glyphicon-edit'></span>Edit</button></div></td></tr>";
            }
    ...
    $('#tblData').on('click', '.edithostid', function () {
