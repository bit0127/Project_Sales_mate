...
$(function () {
    ...
    $('#dvMiddleContent').html("<div style='width:70%;height:36px;margin-top: 5px;background-color:#8dc060;text-align:center;color:#fff;font-size:25px;padding-top:10px;margin-top:10px;margin-left:15%;'><span>Outlet wise Order Memo</span></div>" +
    ...
    $("#btnShow").click(function () {
        ...
        if (dmId == "-1") {
            ...
            var url = "outletmemo.aspx?dm=" + dmId + "&sr=" + srId + "&orderdate=" + orderDate;
