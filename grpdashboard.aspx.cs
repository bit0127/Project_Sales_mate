...
public partial class grpdashboard : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        GetNationalSalesvsTargetData("01/01/2017", "31/01/2017");
    }

    [WebMethod(EnableSession = true)]
    public static List<DataInfo> GetNationalSalesData(string fromDate, string toDate)
    {
        ...
        try
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                dataList.Add(new DataInfo(hos, val));
    ...
    [WebMethod(EnableSession = true)]
    public static List<DataInfo> GetDivisionalSalesData(string fromDate, string toDate)
    {
        List<DataInfo> dataList = new List<DataInfo>();
        try
        {
    ...
    { 
        ...
        data.addRows(" + dt.Rows.Count + ");");
            ...
            str.Append("hAxis: {title: 'Group Name', titleTextStyle: {color: 'green'}}");
...
public class DataInfo
{
    ...
    public DataInfo(string columnName, int value)
    {
